...
namespace hotel_api.Notifications.Email
{
    public class RoomShiftEmailNotification
    {
        ...
        private GuestDetails GuestDetails { get; set; } = new GuestDetails();

        private string PreviousRoom { get; set; } = string.Empty;
        public string NewRoom { get; set; } = string.Empty;
        public string ShiftDate { get; set; } = string.Empty;

        public RoomShiftEmailNotification(DbContextSql context, CompanyDetails propertyDetails, string reservationNo, GuestDetails guestDetails, string previousRoom, string newRoom, string shiftDate)
        {
            _context = context;
...
<head>
    <meta charset=""UTF-8"">
    <title>Room Shift Successful</title>
</head>
    ...
    <table width=""100%"" style=""max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"">
        ...
        <tr>
            <td style=""padding: 20px; color: #333333;"">
                ...
                <p>We are pleased that your Room Shifted sucessfully!</p>
                ...
                <table width=""100%"" style=""margin-top: 20px;"">
                    ...
                    <tr>
                        <td style=""padding: 8px; color: #555555;""><strong>Old Room:</strong></td>
                        <td style=""padding: 8px; color: #555555;"">{PreviousRoom}</td>
                    </tr>

                    <tr>
                        <td style=""padding: 8px; color: #555555;""><strong>New Room:</strong></td>
                        <td style=""padding: 8px; color: #555555;"">{NewRoom}</td>
                    </tr>

                    <tr>
                        <td style=""padding: 8px; color: #555555;""><strong>Shift Date:</strong></td>
                        <td style=""padding: 8px; color: #555555;"">{ShiftDate}</td>
                    </tr>
                </table>
