            ...
            try
            {
                ...
                response.Services = await (from service in _context.ServicableMaster
                                           ...
                                           select new ServicesDTO
                                           {
                                               ...
                                               CurrentDiscountAmount = service.Discount,
            ...
            try 
            {
                ...
                foreach(var service in dto.ServiceItems)
                {
                    ...
                    var advanceService = new AdvanceService
                    {
                        ...
                        ServicePrice = service.ServicePrice - service.DiscountAmount,
                        TotalServicePrice = (service.ServicePrice * service.Quantity )-(service.Quantity * service.DiscountAmount),
